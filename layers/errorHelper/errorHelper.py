...
class ErrorHandler:
    ...
    @classmethod
    def handle_dynamodb_error(cls, error: Exception, operation: str, context: Dict[str, Any] = None) -> Tuple[str, Dict[str, Any]]:
        """
    ...
    @classmethod
    def handle_authorization_error(cls, user_sub: str, server_id: str, required_permission: str, 
                                 user_role: Optional[str] = None, reason: str = None) -> Dict[str, Any]:
        """
        ...
        if not user_role:
            ...
            operation_permissions = {
                ...
                'control_server': 2, 'manage_users': 3, 'manage_config': 3
            }
            
            required_level = operation_permissions.get(required_permission, 3)
            required_role = next((role for role, level in permission_levels.items() 
                                if level >= required_level), 'admin')
    ...
    @classmethod
    def log_membership_operation(cls, operation: str, user_id: str, server_id: str, 
                               role: str = None, initiated_by: str = None, success: bool = True, 
                               error: str = None):
        """
    ...
    @classmethod
    def log_authorization_attempt(cls, user_sub: str, server_id: str, required_permission: str, 
                                user_role: str = None, success: bool = True, reason: str = None):
        """
...
class MigrationErrorHandler:
    ...
    @classmethod
    def log_migration_progress(cls, stage: str, total_users: int = None, processed_users: int = None, 
                             server_id: str = None, success: bool = True, error: str = None):
        """
    ...
    @classmethod
    def create_migration_report(cls, total_servers: int, successful_servers: int, 
                              total_users: int, successful_users: int, 
        ...
        report = {
            ...
            'users': {
                ...
                'failed': total_users - successful_users
            },
            'success_rate': {
